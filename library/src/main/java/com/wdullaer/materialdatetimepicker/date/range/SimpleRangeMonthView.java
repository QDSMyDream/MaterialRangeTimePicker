...
public class SimpleRangeMonthView extends MonthRangeView {

    public SimpleRangeMonthView(Context context, AttributeSet attr, DatePickerRangeController controller) {
