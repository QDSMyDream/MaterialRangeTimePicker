...
public class TextViewRangeWithCircularIndicator extends  androidx.appcompat.widget.AppCompatTextView {
    ...
    public TextViewRangeWithCircularIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
