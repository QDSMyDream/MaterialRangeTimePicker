...
package com.wdullaer.materialdatetimepicker.date.range.time;
 ...
 */
public class RadialRangePickerLayout extends FrameLayout implements OnTouchListener {
    ...
    private static final int HOUR_INDEX = TimePickerRangeDialog.HOUR_INDEX;
    private static final int MINUTE_INDEX = TimePickerRangeDialog.MINUTE_INDEX;
    private static final int AMPM_INDEX = TimePickerRangeDialog.AMPM_INDEX;
    private static final int ENABLE_PICKER_INDEX = TimePickerRangeDialog.ENABLE_PICKER_INDEX;
    private static final int AM = TimePickerRangeDialog.AM;
    private static final int PM = TimePickerRangeDialog.PM;
    ...
    private CircleRnageView mCircleView;
    private AmPmRangeCirclesView mAmPmCirclesView;
    private RadialRangeTextsView mHourRadialTextsView;
    private RadialRangeTextsView mMinuteRadialTextsView;
    private RadialRangeSelectorView mHourRadialSelectorView;
    private RadialRangeSelectorView mMinuteRadialSelectorView;
    ...
    public RadialRangePickerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mCircleView = new CircleRnageView(context);
        addView(mCircleView);

        mAmPmCirclesView = new AmPmRangeCirclesView(context);
        addView(mAmPmCirclesView);

        mHourRadialSelectorView = new RadialRangeSelectorView(context);
        addView(mHourRadialSelectorView);
        mMinuteRadialSelectorView = new RadialRangeSelectorView(context);
        addView(mMinuteRadialSelectorView);

        mHourRadialTextsView = new RadialRangeTextsView(context);
        addView(mHourRadialTextsView);
        mMinuteRadialTextsView = new RadialRangeTextsView(context);
    ...
    **/
     ...
     * @param is24HourMode
     */
    public void initialize(Context context, TimePickerRangeDialog timePickerDialog,
    ...
    private int reselectSelector(int degrees, boolean isInnerCircle,
        ...
        RadialRangeSelectorView radialSelectorView;
