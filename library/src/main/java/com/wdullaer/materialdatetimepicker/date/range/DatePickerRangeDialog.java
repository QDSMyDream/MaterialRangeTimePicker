 ...
 */
public class DatePickerRangeDialog extends DialogFragment implements
        OnClickListener,DatePickerRangeController {
    ...
    private DayRangePickerView mDayPickerView;
    private YearRangePickerView mYearPickerView;
    ...
    private SimpleRangeDayPickerView mDayPickerViewEnd;
    private YearRangePickerView mYearPickerViewEnd;
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(DatePickerRangeDialog view, int year, int monthOfYear, int dayOfMonth, int yearEnd, int monthOfYearEnd, int dayOfMonthEnd);
    }
     ...
     */
    public static DatePickerRangeDialog newInstance(OnDateSetListener callBack, int year,
            int monthOfYear,
            int dayOfMonth) {
        DatePickerRangeDialog ret = new DatePickerRangeDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDayOfWeekView = (TextView) view.findViewById(R.id.mdtp_date_picker_header);
        ...
        mDayPickerView = new SimpleRangeDayPickerView(activity, this);
        mYearPickerView = new YearRangePickerView(activity, this);
        mDayPickerViewEnd = new SimpleRangeDayPickerView(activity, this);
        mYearPickerViewEnd = new YearRangePickerView(activity, this);
        ...
        okButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                tryVibrate();
                if (mCallBack != null) {
                    mCallBack.onDateSet(DatePickerRangeDialog.this, mCalendar.get(Calendar.YEAR),
        ...
        tabHost.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                MonthRangeAdapter.CalendarDay calendarDay;
                if(tabId.equals("start")){
                    calendarDay = new MonthRangeAdapter.CalendarDay(mCalendar.getTimeInMillis());
                    mDayPickerView.goTo(calendarDay,true,true,false);
                }
                else{
                    calendarDay = new MonthRangeAdapter.CalendarDay(mCalendarEnd.getTimeInMillis());
    ...
    @Override
    public MonthRangeAdapter.CalendarDay getSelectedDay() {
        if(tabHost.getCurrentTab()==0){
            return new MonthRangeAdapter.CalendarDay(mCalendar);
        }else{
            return new MonthRangeAdapter.CalendarDay(mCalendarEnd);
        }
