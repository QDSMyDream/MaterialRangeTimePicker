 ...
 */
public abstract class MonthRangeView extends View {
    ...
    protected DatePickerRangeController mController;
    ...
    public MonthRangeView(Context context) {
        this(context, null, null);
    }

    public MonthRangeView(Context context, AttributeSet attr, DatePickerRangeController controller) {
        super(context, attr);
    ...
    public void setDatePickerController(DatePickerRangeController controller) {
        mController = controller;
    }
    ...
    private void onDayClick(int day) {
        ...
        if (mOnDayClickListener != null) {
            mOnDayClickListener.onDayClick(this, new MonthRangeAdapter.CalendarDay(mYear, mMonth, day));
        }
     ...
     *         has focus
     */
    public MonthRangeAdapter.CalendarDay getAccessibilityFocus() {
        final int day = mTouchHelper.getFocusedVirtualView();
        if (day >= 0) {
            return new MonthRangeAdapter.CalendarDay(mYear, mMonth, day);
        }
        return null;
    }
     ...
     */
    public boolean restoreAccessibilityFocus(MonthRangeAdapter.CalendarDay day) {
    ...
    protected class MonthViewTouchHelper extends ExploreByTouchHelper {
        ...
        public void setFocusedVirtualView(int virtualViewId) {
            getAccessibilityNodeProvider(MonthRangeView.this).performAction(
    ...
    public interface OnDayClickListener {
        void onDayClick(MonthRangeView view, MonthRangeAdapter.CalendarDay day);
    }
}
