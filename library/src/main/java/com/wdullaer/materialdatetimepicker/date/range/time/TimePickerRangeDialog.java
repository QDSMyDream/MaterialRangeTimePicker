 ...
 */
public class TimePickerRangeDialog extends DialogFragment implements RadialRangePickerLayout.OnValueSelectedListener {
    ...
    private RadialRangePickerLayout mTimePicker;
    ...
    private RadialRangePickerLayout mTimePickerEnd;
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(RadialRangePickerLayout view, int hourOfDay, int minute, int hourOfDayEnd, int minuteEnd);
    }

    public TimePickerRangeDialog() {
    ...
    public static TimePickerRangeDialog newInstance(OnTimeSetListener callback,
            int hourOfDay, int minute, boolean is24HourMode) {
        TimePickerRangeDialog ret = new TimePickerRangeDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTimePicker = (RadialRangePickerLayout) view.findViewById(R.id.range_time_picker);
        mTimePicker.setOnValueSelectedListener(this);
        mTimePicker.setOnKeyListener(keyboardListener);
        mTimePicker.initialize(getActivity(), this, mInitialHourOfDay,
            mInitialMinute, mIs24HourMode);

        mTimePickerEnd = (RadialRangePickerLayout) view.findViewById(R.id.range_time_picker_end);
