 ...
 */
public class RadialRangeSelectorView extends View {
    ...
    public RadialRangeSelectorView(Context context) {
        super(context);
    ...
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle,
        ...
        if (is24HourMode) {
            ...
            mCircleRadiusMultiplier = Float.parseFloat(
                    res.getString(R.string.mdtp_ampm_circle_radius_multiplier ));
    ...
    private class InvalidateUpdateListener implements AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            RadialRangeSelectorView.this.invalidate();
        }
    }
}
